        ...
        ?>
            <form method="get" style="margin-bottom: 20px;">
                ...
                <select name="group_type">
                    <option value="" <?php selected(empty($filters['group_type'])); ?>><?php esc_html_e('All Checks', 'webchangedetector'); ?></option>
                    <option value="post" <?php selected($filters['group_type'] ?? '', 'post'); ?>><?php esc_html_e('Auto Update Checks & Manual Checks', 'webchangedetector'); ?></option>
                    <option value="auto" <?php selected($filters['group_type'] ?? '', 'auto'); ?>><?php esc_html_e('Monitoring Checks', 'webchangedetector'); ?></option>
                </select>
                ...
                <select name="difference_only" class="js-dropdown">
                    <option value="0" <?php selected(empty($filters['difference_only'])); ?>><?php __('All detections', 'webchangedetector') ?></option>
                    <option value="1" <?php selected($filters['difference_only'] ?? '', '1'); ?>><?php __('With difference', 'webchangedetector') ?></option>
                </select>
