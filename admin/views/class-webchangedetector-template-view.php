...
class WebChangeDetector_Template_View {
	 ...
	 */
	public function render_auto_settings( $group_and_urls, $group_id ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter -- Variables used in included template.
		// Used in template.
	 ...
	 * @param string $group_id The group ID.
	 */
	public function render_update_settings( $group_and_urls, $group_id ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter -- Variables used in included template.
		// Used in template.
		// Set up template variables that the template expects.
		// The template expects $this->admin and $this->account_handler to be available.
