...
class WebChangeDetector_Dashboard_Controller {
	...
	private function render_initial_setup_overlay() {
		...
		<div id="wcd-initial-setup-overlay">
			<style>
				.webchangedetector .nav-tab-wrapper {
					display: none;
				}
			</style>
			<div class="wcd-overlay-content">
				<div class="wcd-setup-header">
					<img src="<?php echo esc_url( plugin_dir_url( __DIR__ ) . 'img/logo-webchangedetector.png' ); ?>" alt="WebChangeDetector Logo" class="wcd-setup-logo">
