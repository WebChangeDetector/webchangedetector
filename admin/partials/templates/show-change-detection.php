				...
				if ( $hasBrowserConsoleData ) {
					...
					<div class="wcd-console-indicator wcd-console-changed">
						...
						if ( $changeStatus === 'mixed' ) {
							_e( 'Console Changes Detected', 'webchangedetector' );
						} elseif ( $changeStatus === 'added' ) {
							_e( 'New Error Console Entries', 'webchangedetector' );
						} elseif ( $changeStatus === 'removed' ) {
							_e( 'Error Console Entries Removed', 'webchangedetector' );
						} else {
							_e( 'Console Changed', 'webchangedetector' );
						}
						?>
						</span>
					</div>
