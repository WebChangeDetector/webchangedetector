...
<div id="wcd-currently-in-progress"
	...
	style=" display: <?php echo esc_html( $sc_processing ) ? 'block' : 'none'; ?>">

	<div id="currently-processing-container" >
		<div id="currently-processing" style="font-size: 50px; line-height: 50px; font-weight: 700;"><?php echo esc_html( $sc_processing ); ?></div>
