	...
	<div id="auto_update_checks_settings">
		...
		<div style="padding: 10px; " class="auto-setting toggle">
			...
			<div style="display: inline-block">
				<input name="auto_update_checks_monday" type="checkbox" <?php echo $auto_update_settings['auto_update_checks_monday']; ?> class="auto_update_checks_monday">
				<label for="auto_update_checks_monday" style="min-width: inherit">Monday </label><br>
				<input name="auto_update_checks_tuesday" type="checkbox" <?php echo $auto_update_settings['auto_update_checks_tuesday']; ?> class="auto_update_checks_tuesday">
				<label for="auto_update_checks_monday" style="min-width: inherit">Tuesday </label><br>
				<input name="auto_update_checks_wednesday" type="checkbox" <?php echo $auto_update_settings['auto_update_checks_wednesday']; ?> class="auto_update_checks_wednesday">
				<label for="auto_update_checks_wednesday" style="min-width: inherit">Wednesday </label><br>
				<input name="auto_update_checks_thursday" type="checkbox" <?php echo $auto_update_settings['auto_update_checks_thursday']; ?> class="auto_update_checks_thursday">
				<label for="auto_update_checks_thursday" style="min-width: inherit">Thursday </label><br>
				<input name="auto_update_checks_friday" type="checkbox" <?php echo $auto_update_settings['auto_update_checks_friday']; ?> class="auto_update_checks_friday">
				<label for="auto_update_checks_friday" style="min-width: inherit">Friday </label><br>
				<input name="auto_update_checks_saturday" type="checkbox" <?php echo $auto_update_settings['auto_update_checks_saturday']; ?> class="auto_update_checks_saturday">
				<label for="auto_update_checks_saturday" style="min-width: inherit">Saturday </label><br>
				<input name="auto_update_checks_sunday" type="checkbox" <?php echo $auto_update_settings['auto_update_checks_sunday']; ?> class="auto_update_checks_sunday">
		...
		<div style="padding: 10px; " class="auto-setting toggle" >
			...
			<input name="auto_update_checks_emails" style="width: calc(100% - 160px)" type="text" value="<?php echo $auto_update_settings['auto_update_checks_emails']; ?>" class="auto_update_checks_emails">
		</div>
	</div>
